...
# Solution
Loop from the left top corner over all numbers (ignoring the edge at the right and the bottom), and keeping track of the product of numbers

## Optimization
Keeping track of the smallest number of the product can allow you to skip some products
